...
export function Footer() {
  const socialLinks = [
    ...
    },
    {
      ...
      href: "mailto:contact@ashish.com",
      label: "Email",
    },
  ];
  ...
  return (
    <ModemAnimatedFooter
      brandName="Ashish"
      brandDescription="Creative developer supporting designers and agencies with modern web experiences."
      socialLinks={socialLinks}
      navLinks={navLinks}
      creatorName="Ashish"
      creatorUrl="https://ashish.com"
      brandIcon={

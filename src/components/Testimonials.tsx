...
export function Testimonials() {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full px-6 md:px-12 py-24 md:py-32 flex flex-col gap-16 md:gap-20 border-t border-[#0A0A0A]/10"
    >
      {testimonials.map((t, i) => (
        <div
          key={i}
          className="testimonial-item flex flex-col w-full max-w-5xl mx-auto text-center"
        >
